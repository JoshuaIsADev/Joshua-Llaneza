const workData = [
  {
    id: 1,
    title: 'Post Carry Co.',
    client: 'Post Carry Co.',
    tech: ['React', 'React Query', 'Supabase', 'Styled components', 'CSS'],
    features: ['E-commerce', 'Shopify', 'API fetch'],
    summary: `Client wanted a refresh for their e-commerce website and wanted the ability to edit content through Shopify.`,
    liveLink: 'http://postcarry.co',
  ...
  {
    id: 2,
    title: 'maikallaneza.com & CMS',
    client: 'Maika LLaneza',
    tech: ['React', 'React Query', 'Supabase', 'Styled components', 'CSS'],
    features: ['Create', 'Write', 'Update', 'Delete'],
